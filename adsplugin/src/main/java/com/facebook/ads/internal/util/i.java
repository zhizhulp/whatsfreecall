...
public class i
{
    ...
    private i(final String a, final String b, final String c, final List<String> d, final String e, final String f) {
        this.a = a;
        this.b = b;
        this.c = c;
        this.d = d;
    ...
    public static i a(final JSONObject jsonObject) {
        ...
        return new i(optString, optString2, optString3, list, jsonObject.optString("market_uri"), jsonObject.optString("fallback_url"));
    }
}
