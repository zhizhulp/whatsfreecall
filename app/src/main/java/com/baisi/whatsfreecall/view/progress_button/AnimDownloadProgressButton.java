...
public class AnimDownloadProgressButton extends AppCompatTextView {
    private String TAG="AnimDownloadProgressButton";
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mAboveTextSize = dp2px(a.getFloat(R.styleable.AnimDownloadProgressButton_progressbtn_text_size, 15));
        ...
        mCurrentText = a.getString(R.styleable.AnimDownloadProgressButton_progressbtn_current_text);
        a.recycle();
    }
    ...
    public void setProgressText(String text, float progress) {
        if (progress >= mMinProgress && progress < mMaxProgress) {
            mCurrentText = text + getResources().getString(R.string.downloaded, String.valueOf((int) progress));
            ...
            mProgress = 100;
            mCurrentText = text + getResources().getString(R.string.downloaded, String.valueOf((int) mProgress));
            invalidate();
        }
    }
    ...
    private float dp2px(float dpValue){
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16,getContext().getResources().getDisplayMetrics());
    }
