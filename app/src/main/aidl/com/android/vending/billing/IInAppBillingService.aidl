...
interface IInAppBillingService {
    ...
    /**
     * Returns the current SKUs owned by the UserEntity of the type and package name specified along with
     ...
     *                                      UserEntity has more owned skus than the current list.
     */
    Bundle getPurchases(int apiVersion, String packageName, String type, String continuationToken);

    /**
     * ConsumeEntity the last purchase of the given SKU. This will result in this item being removed
     ...
     * the UserEntity is upgrading or downgrading to.
     * @param apiVersion billing API version that the app is using, must be 5 or later
     * @param packageName package name of the calling app
     * @param oldSkus the SKU(s) that the UserEntity is upgrading or downgrading from,
     *        if null or empty this method will behave like {@link #getBuyIntent}
     * @param newSku the SKU that the UserEntity is upgrading or downgrading to
     ...
     *        "skusToReplace" - List<String> - an optional list of SKUs that the UserEntity is
     *                          upgrading or downgrading from.
     *                          Pass this field if the purchase is upgrading or downgrading
     *                          existing subscriptions.
     *                          The specified SKUs are replaced with the SKUs that the UserEntity is
     *                          purchasing. Google Play replaces the specified SKUs at the start of
     *                          the next billing cycle.
     * "replaceSkusProration" - Boolean - whether the UserEntity should be credited for any unused
     ...
     *                          and credits the UserEntity with the unused value of their subscription
     *                          time on a pro-rated basis.
     *                          Google Play applies this credit to the new subscription, and does
     *                          not begin billing the UserEntity for the new subscription until after
     *                          the credit is used up.
     *                          If you set this field to false, the UserEntity does not receive credit for
     ...
     *                          associated with the UserEntity's account in your app.
     ...
     *                          Do not use the developer ID or the UserEntity's Google ID for this field.
     *                          In addition, this field should not contain the UserEntity's ID in
     *                          cleartext.
     *                          We recommend that you use a one-way hash to generate a string from
     *                          the UserEntity's ID, and store the hashed string in this field.
    ...
    /**
     * Returns the most recent purchase made by the UserEntity for each SKU, even if that purchase is
